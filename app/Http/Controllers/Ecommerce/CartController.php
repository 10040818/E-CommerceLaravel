...
class CartController extends Controller
{
    ...
    public function getCourier(Request $request)
    {
        ...
        $response = $client->request('POST', $url, [
            'headers' => [
                'Authorization' => 'UsxPqinYrTX056W57x4RqFuw2JL2gW94t7HVADLm'
            ],
            'form_params' => [
                'origin' => 22, //ASAL PENGIRIMAN, 22 = BANDUNG
                'destination' => $request->destination,
                'weight' => $request->weight,
                'courier' => 'jnt,sicepat,tiki,lion' //MASUKKAN KEY KURIR LAINNYA JIKA INGIN MENDAPATKAN DATA ONGKIR DARI KURIR YANG LAIN
            ]
        ]);
